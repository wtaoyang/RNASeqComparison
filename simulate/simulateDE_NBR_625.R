...
NBRres[["aFold"]] <- afres
NBRres[["DESeq2q"]] <- dsresq
NBRres[["edgeRq"]] <- edresq
NBRres[["Voomq"]] <- vmresq
NBRres[["baySeqq"]] <- bsresq
NBRres[["ABSSeq"]] <- abres
NBRres[["ROTSq"]] <- rtresq
...
load("bsRNB625res.Rdata")
NBRres[["baySeq"]] <- bsRNBres[["baySeq"]]
NBRres[["baySeqq"]] <- bsRNBres[["baySeqq"]]
save(NBRres,file="NBR625res.Rdata")
...
summary(m3)
TukeyHSD(m3)
pdf("NBR-q_625_625_scat.pdf",width=12,height=8)
