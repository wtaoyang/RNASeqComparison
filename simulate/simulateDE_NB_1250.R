...
basn="BT_2_"
path="./dataset/SimStudyBT_B_0_1250/2samplespergroup"
...
basn="BT_5_"
path="./dataset/SimStudyBT_B_0_1250/5samplespergroup"
...
basn="BT_10_"
path="./dataset/SimStudyBT_B_0_1250/10samplespergroup"
...
NB1250res=list("aFold"=afres,"aFoldt"=afrest,"aFoldg"=afresg,"aFoldq"=afresq,
...
save(NB1250res,file="NB1250res.Rdata")

load("NB1250res.Rdata")
load("bsRNB1250res.Rdata")
NB1250res[["baySeq"]] <- bsRNB1250res[["baySeq"]]
NB1250res[["baySeqq"]] <- bsRNB1250res[["baySeqq"]]
save(NB1250res,file="NB1250res.Rdata")

NBRres <-NB1250res
###boxplot
pdf("NB1250.pdf",width=12,height=8)
...
boxplot(pd,at=c(1:7,9:15,17:23),frame=T,xlab="",ylab="",main="",axes=F,xlim=c(0.5,23.5),cex.axis=0.7,ylim=c(0.7,1),col=c(2:8))
...
pdf("NBR-q_1250_scat.pdf",width=12,height=8)
