...
basn="QT_2_"
path="./dataset/SimStudyQT_B_2000_2000/2samplespergroup"
...
basn="QT_5_"
path="./dataset/SimStudyQT_B_2000_2000/5samplespergroup"
...
basn="QT_10_"
path="./dataset/SimStudyQT_B_2000_2000/10samplespergroup"
...
NB2000res=list("aFold"=afres,"aFoldt"=afrest,"aFoldg"=afresg,"aFoldq"=afresq,
...
save(NB2000res,file="NB2000res.Rdata")


load("NB2000res.Rdata")
load("bsRNB2000res.Rdata")
NB2000res[["baySeq"]] <- bsRNB2000res[["baySeq"]]
NB2000res[["baySeqq"]] <- bsRNB2000res[["baySeqq"]]
save(NB2000res,file="NB2000res.Rdata")

NBRres <-NB2000res
###boxplot
pdf("NB2000.pdf",width=12,height=8)
...
pdf("NBR-q_2000_scat.pdf",width=12,height=8)
